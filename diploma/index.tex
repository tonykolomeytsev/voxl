...
\newcommand{\includebiblio}[1]{
    ...
    \renewcommand{\chapter}[2]{
        \clearpage
        \stepcounter{chapter}
        \paragraph{\MakeUppercase{Библиографический список}}
        \addcontentsline{toc}{likechapter}{\MakeUppercase{Библиографический список}}
    }
    \bibliographystyle{gost2008} % Стиль библиографических ссылок БибТеХа
    \bibliography{#1}
    \endgroup
}
...
\newcommand{\append}[1]{
    \clearpage
    \stepcounter{chapter}
    \paragraph{\MakeUppercase{\chaptertitlename~\Asbuk{chapter}: #1}}
